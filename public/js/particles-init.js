...
document.addEventListener('DOMContentLoaded', function() {
    if (document.getElementById('particles-js') && typeof particlesJS !== 'undefined') {
      ...
      // --- START: Theme detection and color definition ---
      const htmlEl = document.documentElement;
      const isDarkMode = htmlEl.classList.contains('dark-mode');
  
      // Define colors for both themes (adjust these hex codes to your liking)
      ...
      // --- END: Theme detection and color definition ---
      ...
      particlesJS('particles-js', {
        "particles": {
          ...
          "color": {
            // Use the dynamically determined particle color
          ...
          "line_linked": {
            "enable": true,
            "distance": 150,
            // Use the dynamically determined line color
      ...
      // console.log('particles.js initialized with theme-aware colors'); // Optional log
  
    } else {
      // Error logging from before
